    ...
    <div class="form-v9-content">
      <form class="form-detail" @submit.prevent="submitForm">
        <div class="router-links">
          <router-link
            to="/CargarLugar"
            class="custom-link-left"
            :class="{ 'active-link': $route.path === '/CargarLugar' }"
          >
            <h2 id="h2">Agregar Lugar</h2>
          </router-link>
          <router-link
            to="/CargarCiudad"
            class="custom-link-right"
            :class="{ 'active-link': $route.path === '/CargarCiudad' }"
          >
            <h2 id="h22">Agregar Ciudad</h2>
          </router-link>
        </div>
